...
const privacyTranslations = [
  ...
  ['Última atualização: 8 de setembro de 2026.', 'Last updated: September 8, 2026.'],
  ...
  ['Publicidade', 'Advertising'], ['O código-base do Google AdSense é carregado para verificar o domínio e preparar a exibição de anúncios com o consentimento negado por padrão. O armazenamento publicitário, a personalização e a medição de campanhas só são autorizados após sua escolha. Esses serviços podem tratar identificadores e dados técnicos conforme suas próprias políticas.', 'The base Google AdSense code loads to verify the domain and prepare ad delivery with consent denied by default. Advertising storage, personalization, and campaign measurement are only authorized after your choice. These services may process identifiers and technical data under their own policies.'],
